...
1. **Start with a basic prompt.** Just describe what we want. See what happens.
2. **Watch where it fails.** The model will get things wrong. Good. Now we know where the edges are.
